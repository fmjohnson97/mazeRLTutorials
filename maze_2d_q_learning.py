...
def select_action(state, explore_rate): #epsilon greedy strategy
...
if __name__ == "__main__":
    ...
    maze_size = (6,6) #ToDo: instead of specifying a maze path, you can specify a maze size (x,y) and a random maze will be generated
